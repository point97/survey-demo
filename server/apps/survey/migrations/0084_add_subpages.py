...
class Migration(DataMigration):
    ...
    def forwards(self, orm):
        ...
        SurveySubpage = orm['survey.SurveySubpage']
        Survey = orm['survey.Survey']

        market = Survey.objects.get(slug="fish-market-survey")
        logbook = Survey.objects.get(slug="fishers-logbook")
        basics = Survey.objects.get(slug="general-applicationmulti-use-survey")

        SurveySubpage.objects.create(controller="logbookTrapCtrl.js", survey=logbook, name="Trap")
        SurveySubpage.objects.create(controller="logbookPassengerFishingCtrl.js", survey=logbook, name="Passenger Fishing")
        SurveySubpage.objects.create(controller="logbookDiveCtrl.js", survey=logbook, name="Dive")

        SurveySubpage.objects.create(controller="marketSurveyMarketReportCtrl.js", survey=market, name="Market Report")
        SurveySubpage.objects.create(controller="marketSurveyCatchReportCtrl.js", survey=market, name="Catch Report")

        SurveySubpage.objects.create(controller="basicSurveyReportCtrl.js", survey=basics, name="Survey Report")
    ...
    models = {
        ...
        u'survey.respondant': {
            ...
            'csv_row': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['reports.CSVRow']", 'null': 'True', 'blank': 'True'}),
            ...
            'uuid': ('django.db.models.fields.CharField', [], {'default': "'aeb6a991-8ceb-4318-b82d-e62377687bbf'", 'max_length': '36', 'primary_key': 'True'}),
        ...
        u'survey.surveysubpage': {
            'Meta': {'object_name': 'SurveySubpage'},
