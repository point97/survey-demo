...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'RespondantListColumn'
        db.create_table(u'survey_respondantlistcolumn', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('column_name', self.gf('django.db.models.fields.CharField')(max_length=254)),
        ...
        db.send_create_signal(u'survey', ['RespondantListColumn'])


    def backwards(self, orm):
        # Deleting model 'RespondantListColumn'
        db.delete_table(u'survey_respondantlistcolumn')
    ...
    models = {
        ...
        u'survey.respondant': {
            ...
            'uuid': ('django.db.models.fields.CharField', [], {'default': "'65335967-5cc4-4328-9146-7034d3f8dd8e'", 'max_length': '36', 'primary_key': 'True'}),
