...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Respondant.fish_types'
        db.add_column(u'survey_respondant', 'fish_types',
                      self.gf('django.db.models.fields.CharField')(max_length=240, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Respondant.fish_types'
        db.delete_column(u'survey_respondant', 'fish_types')
    ...
    models = {
        ...
        u'survey.respondant': {
            ...
            'fish_types': ('django.db.models.fields.CharField', [], {'max_length': '240', 'null': 'True', 'blank': 'True'}),
            ...
            'uuid': ('django.db.models.fields.CharField', [], {'default': "'127e5f9f-6523-45a5-b6b1-a2e2e369eef9'", 'max_length': '36', 'primary_key': 'True'}),
