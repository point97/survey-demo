...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'SurveySubpage.slug'
        db.add_column(u'survey_surveysubpage', 'slug',
    ...
    def backwards(self, orm):
        # Deleting field 'SurveySubpage.slug'
        db.delete_column(u'survey_surveysubpage', 'slug')
    ...
    models = {
        ...
        u'survey.respondant': {
            ...
            'uuid': ('django.db.models.fields.CharField', [], {'default': "'4483e083-e6cf-48be-a64d-ffa21e3d3d60'", 'max_length': '36', 'primary_key': 'True'}),
