...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Respondant.trip_date'
        db.add_column(u'survey_respondant', 'trip_date',
                      self.gf('django.db.models.fields.CharField')(max_length=240, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Respondant.landing_port'
        db.add_column(u'survey_respondant', 'landing_port',
                      self.gf('django.db.models.fields.CharField')(max_length=240, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Respondant.trip_date'
        db.delete_column(u'survey_respondant', 'trip_date')

        # Deleting field 'Respondant.landing_port'
        db.delete_column(u'survey_respondant', 'landing_port')
    ...
    models = {
        ...
        u'survey.respondant': {
            ...
            'landing_port': ('django.db.models.fields.CharField', [], {'max_length': '240', 'null': 'True', 'blank': 'True'}),
            ...
            'logbook': ('django.db.models.fields.CharField', [], {'max_length': '240', 'null': 'True', 'blank': 'True'}),
            'market_surveyed': ('django.db.models.fields.CharField', [], {'max_length': '240', 'null': 'True', 'blank': 'True'}),
            ...
            'trip_date': ('django.db.models.fields.CharField', [], {'max_length': '240', 'null': 'True', 'blank': 'True'}),
            'ts': ('django.db.models.fields.DateTimeField', [], {}),
            'updated_at': ('django.db.models.fields.DateTimeField', [], {'auto_now': 'True', 'null': 'True', 'blank': 'True'}),
            'uuid': ('django.db.models.fields.CharField', [], {'default': "'3c026713-c280-480c-ad2f-19f887c7dc17'", 'max_length': '36', 'primary_key': 'True'}),
            'vendor': ('django.db.models.fields.CharField', [], {'max_length': '240', 'null': 'True', 'blank': 'True'})
        },
        u'survey.respondantlistcolumn': {
            'Meta': {'object_name': 'RespondantListColumn'},
            'column_name': ('django.db.models.fields.CharField', [], {'max_length': '254'}),
