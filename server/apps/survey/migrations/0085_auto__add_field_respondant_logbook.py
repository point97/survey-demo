...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Respondant.logbook'
        db.add_column(u'survey_respondant', 'logbook',
                      self.gf('django.db.models.fields.CharField')(max_length=240, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Respondant.logbook'
        db.delete_column(u'survey_respondant', 'logbook')
    ...
    models = {
        ...
        u'survey.respondant': {
            ...
            'uuid': ('django.db.models.fields.CharField', [], {'default': "'34267314-97a2-46d8-85ef-60b9e241ef3b'", 'max_length': '36', 'primary_key': 'True'}),
