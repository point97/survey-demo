...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Respondant.market_surveyed'
        db.add_column(u'survey_respondant', 'market_surveyed',
                      self.gf('django.db.models.fields.CharField')(max_length=240, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Respondant.market_surveyed'
        db.delete_column(u'survey_respondant', 'market_surveyed')
    ...
    models = {
        ...
        u'survey.respondant': {
            ...
            'uuid': ('django.db.models.fields.CharField', [], {'default': "'6ba23e19-8791-456e-b386-2552031c5878'", 'max_length': '36', 'primary_key': 'True'}),
